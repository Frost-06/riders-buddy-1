  ...
  return (
    <Box sx={{ width: "100%", marginTop: "-35%" }}>
      ...
      <TabPanel value={value} index={0}>
        <Typography variant="h1" style={{fontWeight: "bold", marginBottom: "32px"}}>Service Details</Typography>
        ...
        <Typography variant="h1" style={{fontWeight: "bold", marginBottom: "32px", marginTop: "32px"}}>Service Expectations</Typography>
